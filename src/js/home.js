const menu = document.getElementById("menu");
      ...
      const products = [
        ...
        {id: 3 ,img:"./img/works3.jpg",name: "36 Days of Malayalam type", age:"2020", address :"Dashboard", description:"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet."}
    ];

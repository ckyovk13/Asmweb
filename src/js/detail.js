const menu = document.getElementById("menu");
      ...
      const products = [
        ...
        {id: 4 ,img:"./img/works4.jpg",name: "Components", age:"2018", address :"Components, Design", description:"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet."},
    ];
